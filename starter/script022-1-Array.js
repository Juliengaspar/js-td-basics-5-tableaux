...
console.log(semaine[0])//affichier le prmeeir elements du tableaux grace a l'indice0
console.log(semaine[6])//affichier le dernier elements du tableaux grace a l'indice6
console.log(semaine[semaine.length-1])//affichier le dernier elements du tableaux grace a l'indice6
